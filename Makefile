...
zap: main.o HuffmanCoder.o HuffmanTreeNode.o ZapUtil.o phaseOne.o
	$(CXX) ${LDFLAGS} -o $@ $^

HuffmanCoder.o: HuffmanCoder.cpp HuffmanCoder.h HuffmanTreeNode.h ZapUtil.h
	$(CXX) $(CXXFLAGS) -c HuffmanCoder.cpp 
main.o: main.cpp HuffmanCoder.cpp HuffmanTreeNode.h ZapUtil.h phaseOne.h
